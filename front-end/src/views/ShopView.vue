...
onMounted(async () => {
  await productStore.getProducts(1, 20, '', true)
  await categoryStore.getCategories(1, 1000, '', true)
})
            ...
            <div
              ...
              <div class="relative flex justify-center flex-1 overflow-hidden rounded-[5px] bg-gray-50">
                <img
                  ...
                  :class="{ 'grayscale opacity-60': item.stock_quantity === 0 }" :src="item.images && item.images.length > 0
