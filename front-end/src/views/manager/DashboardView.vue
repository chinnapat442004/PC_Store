...
const pastelColors = ['#6EE7B7', '#93C5FD', '#F9A8D4', '#FDE68A', '#C4B5FD', '#F87171']
...
<template>
  <div class="mb-6 space-y-6">
    <h1 class="text-2xl md:text-3xl font-bold text-white">Manager Dashboard</h1>
    ...
    <div class="flex flex-wrap gap-4">
      ...
      <div class="bg-white rounded-2xl p-4 shadow flex-1 min-w-[220px]">
        ...
        <h2 class="text-xl md:text-2xl font-bold text-gray-900 mt-2">
          {{ dashboardStore.managerDashboard?.kpi.countStaff }} คน
        </h2>
      </div>
    </div>
    ...
    <div class="w-full bg-white rounded-2xl shadow p-5">
      ...
      <div class="grid gap-4 text-center grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
    ...
    <div class="flex flex-wrap gap-4 items-stretch">
      <div class="w-full lg:flex-1 bg-white rounded-2xl shadow p-5 h-[420px] flex flex-col">
        <h2 class="text-lg font-semibold text-gray-800 mb-4">แนวโน้มยอดขาย 7 วัน</h2>
      ...
      <div
        class="w-full lg:flex-1 bg-white rounded-2xl shadow p-5 h-[420px] flex flex-col overflow-hidden"
      >
        <h2 class="text-lg font-semibold text-gray-800 mb-4">สินค้าใกล้หมด</h2>

        <div class="flex-1 overflow-y-auto pr-2">
          <div
            v-for="item in dashboardStore.managerDashboard?.lowStock"
            :key="item.product_id"
    ...
    <div class="flex flex-wrap gap-4">
      <div class="w-full lg:flex-[1] bg-white rounded-2xl shadow p-5">
        ...
        <table class="w-full text-left text-black">
          ...
          <tbody class="divide-y text-gray-700">
            <tr
              v-for="product in dashboardStore.managerDashboard?.topProducts"
      ...
      <div class="w-full lg:flex-[1] bg-white rounded-2xl shadow p-5">
        <h2 class="text-lg font-semibold text-gray-800 mb-4">ยอดขายตามหมวด</h2>
