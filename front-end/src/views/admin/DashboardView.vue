...
<template>
  <div class="mb-6 space-y-6">
    ...
    <div class="flex flex-wrap gap-4">
      <div class="w-full lg:flex-[3] bg-white rounded-2xl shadow p-5">
        <div class="flex items-center justify-between mb-4">
          <div>
            <h2 class="text-lg font-semibold text-gray-800">แนวโน้มยอดขาย 7 วัน</h2>
            <p class="text-sm text-gray-500">รายได้ย้อนหลังรายวัน</p>
          </div>
        </div>
      ...
      <div class="w-full lg:flex-[1] bg-white rounded-2xl shadow p-5">
        <div class="space-y-4">
          <h2 class="text-lg font-semibold text-gray-800">ยอดขายตามหมวด</h2>
    ...
    <div class="flex flex-wrap gap-4">
      <div class="w-full lg:flex-[1] bg-white rounded-2xl shadow p-5">
        ...
        <table class="w-full text-left text-black">
          ...
          <tbody class="divide-y text-gray-700">
            <tr
              v-for="product in dashboardStore.adminDashboard?.topProducts"
      ...
      <div class="w-full lg:flex-[1] bg-white rounded-2xl shadow p-5">
        <h2 class="text-lg font-semibold text-gray-800 mb-4">ผู้ใช้งานในระบบ</h2>
