    ...
    <table class="w-full text-left text-black">
      ...
      <tbody class="divide-y">
        ...
        <tr v-else v-for="coupon in couponStore.coupons" :key="coupon.coupon_id">
          ...
          <td class="px-3 py-3">
            <ToggleSwitch
              :modelValue="coupon.is_active"
              @update:modelValue="
                couponStore
                  .toggleCouponActive(coupon.coupon_id)
                  .then(() => couponStore.getCoupons())
              "
            />
          </td>
    ...
    <div class="dialog w-[500px] max-h-[90vh] flex flex-col overflow-y-auto">
      ...
      <div class="grid grid-cols-2 gap-3 mb-3">
        <div>
          ...
          <input
            v-model="couponStore.editedCoupon.code"
            type="text"
        ...
        <div>
          ...
          <select
            v-model="couponStore.editedCoupon.discount_type"
            class="border w-full px-3 py-2 rounded bg-gray-50"
          >
      ...
      <div class="mb-3">
        ...
        <input
          v-model="couponStore.editedCoupon.description"
          type="text"
      ...
      <div class="grid grid-cols-2 gap-3 mb-3">
        <div>
          ...
          <input
            v-model.number="couponStore.editedCoupon.discount_value"
            type="number"
            class="border w-full px-3 py-2 rounded bg-gray-50"
            :placeholder="
              couponStore.editedCoupon.discount_type === 'percent' ? 'เช่น 10 (%)' : 'เช่น 100 บาท'
            "
          />
        </div>
        ...
        <div>
          ...
          <input
            v-model.number="couponStore.editedCoupon.min_order"
            type="number"
      ...
      <div class="grid grid-cols-2 gap-3 mb-3">
        <div>
          ...
          <input
            v-model.number="couponStore.editedCoupon.max_discount"
            type="number"
            placeholder="กรอกส่วนลดสูงสุด"
            class="border w-full px-3 py-2 rounded bg-gray-50"
          />
        </div>
        ...
        <div>
          ...
          <input
            v-model.number="couponStore.editedCoupon.usage_limit"
            type="number"
      ...
      <div class="mb-3 grid grid-cols-2 gap-2">
        <div>
          ...
          <input
            v-model="couponStore.editedCoupon.start_date"
            type="date"
            class="border w-full px-3 py-2 rounded bg-gray-50"
          />
        </div>
        ...
        <div>
          ...
          <input
            v-model="couponStore.editedCoupon.end_date"
            type="date"
            class="border w-full px-3 py-2 rounded bg-gray-50"
          />
        </div>
