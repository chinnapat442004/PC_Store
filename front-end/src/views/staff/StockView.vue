...
<template>
  ...
  <div v-else class="bg-white rounded-lg overflow-hidden">
    ...
    <div class="flex justify-end items-center gap-4 py-4 border-t mr-3">
      ...
      <span class="text-sm text-gray-600"> {{ stockStore.page }} of {{ stockStore.lastPage }}</span>
  ...
  <div v-if="showDialog" class="overlay">
    <div class="dialog">
      <h2 class="text-lg font-semibold mb-4">Update Stock</h2>
      ...
      <div class="flex justify-center gap-4">
        <button class="bg-red-500 text-white px-4 py-1 rounded" @click="closeDialog">Cancel</button>

        <button class="bg-green-500 text-white px-4 py-1 rounded" @click="updateStock">Save</button>
      </div>
    </div>
  </div>
