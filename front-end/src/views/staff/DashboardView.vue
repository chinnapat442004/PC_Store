...
<template>
  <div class="mb-6 space-y-6">
    <h1 class="text-2xl md:text-3xl font-bold text-white">Staff Dashboard</h1>
    ...
    <div class="flex flex-wrap gap-4">
      <div class="bg-white rounded-2xl p-4 shadow flex-1 min-w-[200px]">
        ...
        <button
          @click="goToOrders()"
          class="mt-3 w-full flex items-center justify-center gap-2 text-gray-600 py-2 rounded-lg text-sm transition-all duration-200 ease-out hover:text-gray-900 hover:scale-[1.02] active:scale-[0.98]"
        >
    ...
    <div class="w-full bg-white rounded-2xl shadow p-5">
      <div class="flex justify-between items-center mb-4">
        <h2 class="text-lg font-semibold text-gray-800">งานที่ยังค้างอยู่</h2>
      ...
      <div class="grid gap-4 text-center grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
        <div class="bg-amber-50 rounded-xl p-4 border border-amber-100">
          ...
          <button
            ...
            class="mt-1 mx-auto flex items-center justify-center gap-1 text-amber-600 py-1.5 text-sm transition-all duration-200 ease-out hover:text-amber-800 hover:scale-[1.03] active:scale-[0.98]"
          >
            <span class="leading-none">ดูรายการ</span>
            <i class="pi pi-angle-right text-sm leading-none relative top-[1px]"></i>
          </button>
        ...
        <div class="bg-sky-50 rounded-xl p-4 border border-sky-100">
          ...
          <button
            @click="goToOrders('waiting_verify')"
            class="mt-1 mx-auto flex items-center justify-center gap-1 text-sky-500 py-1.5 text-sm transition-all duration-200 ease-out hover:text-sky-600 hover:scale-[1.03] active:scale-[0.98]"
          >
        ...
        <div class="bg-indigo-50 rounded-xl p-4 border border-indigo-100">
          ...
          <button
            @click="goToOrders('computed')"
            class="mt-1 mx-auto flex items-center justify-center gap-1 text-indigo-500 py-1.5 text-sm transition-all duration-200 ease-out hover:text-indigo-600 hover:scale-[1.03] active:scale-[0.98]"
          >
        ...
        <div class="bg-orange-50 rounded-xl p-4 border border-orange-100">
          ...
          <button
            @click="goToOrders('picking')"
            class="mt-1 mx-auto flex items-center justify-center gap-1 text-orange-500 py-1.5 text-sm transition-all duration-200 ease-out hover:text-orange-600 hover:scale-[1.03] active:scale-[0.98]"
          >
        ...
        <div class="bg-emerald-50 rounded-xl p-4 border border-emerald-100">
          ...
          <button
            ...
            class="mt-1 mx-auto flex items-center justify-center gap-1 text-emerald-500 py-1.5 text-sm transition-all duration-200 ease-out hover:text-emerald-600 hover:scale-[1.03] active:scale-[0.98]"
          >
    ...
    <div class="w-full bg-white rounded-2xl shadow p-5 h-[420px] flex flex-col">
      <h2 class="text-lg font-semibold text-gray-800 mb-4">สินค้าใกล้หมด</h2>

      <div class="flex-1 overflow-y-auto pr-2">
        <div
          v-for="item in dashboardStore.staffDashboard?.lowStock"
          :key="item.product_id"
        ...
        >
          ...
          <div class="flex items-center gap-3">
            <span class="text-sm text-gray-500"> เหลือ {{ item.quantity }} ชิ้น </span>
