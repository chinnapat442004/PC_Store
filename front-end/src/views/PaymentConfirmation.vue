  ...
  <div class="min-h-screen w-full flex justify-center p-6">
    <div class="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-3">
      <div class="bg-white p-6 rounded-xl shadow-md">
        <h2 class="text-xl font-semibold text-gray-800 mb-5 text-center">ยืนยันการชำระเงิน</h2>

        <div class="flex justify-center mb-5">
          <img
            class="w-52 h-52 object-contain border rounded-xl p-3 shadow-sm"
        ...
        <div class="bg-gray-50 rounded-xl p-4 space-y-3 text-sm">
          <div class="flex justify-between">
            ...
            <span class="font-medium text-gray-800">{{
              paymentStore.paymentAccount?.promptpay_number
            }}</span>
          </div>
          ...
          <div class="flex justify-between">
            ...
            <span class="font-medium text-gray-800">{{
              paymentStore.paymentAccount?.account_name
            }}</span>
          </div>
        </div>

        <button
          class="mt-4 w-full flex items-center justify-center gap-2 py-2.5 rounded-xl border hover:bg-gray-100"
          @click="copyPromptPay"
        >
        ...
        <div class="mt-6">
          <p class="text-sm font-medium text-gray-700 mb-2">อัปโหลดสลิปการชำระเงิน</p>
          ...
          >
            <span class="text-gray-500 text-sm"> คลิกเพื่ออัปโหลด หรือ ลากรูปมาใส่ </span>
      ...
      <div class="bg-white p-6 rounded-xl shadow-sm border h-fit">
        <h2 class="text-lg font-semibold text-gray-700 mb-4">สรุปรายการสั่งซื้อ</h2>
        ...
        <div
          class="mt-6 bg-yellow-50 border border-yellow-200 p-3 rounded-xl text-sm text-yellow-700"
        >
        ...
        <button
          :disabled="!slipFile"
          @click="submitSlip"
          class="w-full mt-[20px] h-[35px] rounded-[10px] text-white font-medium"
          :class="slipFile ? 'bg-[#82d182] hover:bg-[#69c769]' : 'bg-gray-300 cursor-not-allowed'"
        >
          ยืนยันการชำระเงิน
        </button>
      </div>
